...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center px-4 sm:px-6 text-center overflow-hidden">
      ...
      >
        <motion.p 
          ...
          className="font-mono text-xs sm:text-sm font-medium text-blue-400 mb-4 sm:mb-6 tracking-wider"
        >
          {"<hello-world />"}
        </motion.p>
        ...
        <motion.p 
          ...
          className="mx-auto max-w-2xl text-base sm:text-lg md:text-xl leading-7 sm:leading-8 text-zinc-400 px-2"
        >
          {t("hero", "description")}
        </motion.p>
